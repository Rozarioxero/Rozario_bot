...
const SESSION_ID = process.env.SESSION_ID || "A-S-W-I-N-S-P-A-R-K-Y:f9078eec603f73d60bf3cba1aae03efb";
const SUDO = process.env.SUDO || '916282524515';
...
const BOT_INFO = process.env.BOT_INFO || "ROZARIO-XER-MD; ᴀɴsʜɪғ xᴇʀ;https://i.imgur.com/r3GZeiX.jpeg";
const URL = process.env.URL || "https://www.instagram.com/anshif_xer";
const AUDIO_DATA = process.env.AUDIO_DATA || "X BOT MD;ASWIN SPARKY;https://i.imgur.com/fVCRCYG.jpeg";
const STICKER_DATA = process.env.STICKER_DATA || "ROZARIO XER MD; ᴀɴsʜɪғ xᴇʀ";
